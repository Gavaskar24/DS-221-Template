...
int problem2c(string inputPath, string outputPath){
    ...
    // read sparse matrix 1 from input file
    inputFile >> N;
    for(int i = 0; i < N; i++){
        int x;
        inputFile >> x;
    ...
    for(int i = 0; i < N; i++){
        int x;
        inputFile >> x;
        columnIndices1.push_back(x);
    }
    for(int i = 0; i < N; i++){
        int x;
        inputFile >> x;
        rowPointers1.push_back(x);
    }
    ...
    for(int i = 0; i < N; i++){
        int x;
        inputFile >> x;
        columnIndices2.push_back(x);
    }
    for(int i = 0; i < N; i++){
        int x;
        inputFile >> x;
        rowPointers2.push_back(x);
    }
